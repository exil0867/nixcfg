    ...
    home-manager.users.${vars.user} = {
      ...
      programs.plasma = {
        ...
        configFile = {
          ...
          "dolphinrc"."General"."ViewPropsTimestamp" = "2024,11,23,22,57,54.706";
          ...
          "katerc"."KTextEditor::Search"."Search History" = "panel,theme";
        ...
        dataFile = {
          ...
          "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 admin:\\/run\\/media\\/exil0681\\/d52417ac-44bc-4cf9-8d7f-88f7f8e5d291\\/home\\/exilvm\\/.config\\/ngrok\\/ngrok.yml"."CursorColumn" = 60;
          "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 admin:\\/run\\/media\\/exil0681\\/d52417ac-44bc-4cf9-8d7f-88f7f8e5d291\\/home\\/exilvm\\/.config\\/ngrok\\/ngrok.yml"."CursorLine" = 1;
